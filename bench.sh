...
speed() {
    speed_test '5029' 'AT&T (New York, NY, US)'
	speed_test '3864' 'California Internet Solutions (Los Angeles, CA, US)'
	speed_test '8705' 'Cable One, Inc. (Chicago, IL, US)'
	speed_test '4043' 'SoftLayer Technologies, Inc. (Houston, TX, US)'
	speed_test '15783' 'Sprint (Phoenix, AZ, US)'
	speed_test '4847' 'Hotwire Fision (Philadelphia, PA, US)'
	speed_test '6249' 'Vivint Wireless (San Antonio, TX, US)'
	speed_test '948' 'FastServ Networks LLC (San Diego, CA, US)'
	speed_test '3501' 'Skybeam (Dallas, TX, US)'
	speed_test '5479' 'Sonic.net, Inc (San Jose, CA, US)'
	speed_test '1759' 'Wayne State University (Detroit, MI, US)'
	speed_test '13192' 'University of North Florida (Jacksonville, FL, US)'
	speed_test '6795' 'Unlimited Net, LLC (Indianapolis, IN, US)'
	speed_test '603' 'Unwired (San Francisco, CA, US)'
	speed_test '3119' 'RackSquared (Columbus, OH, US)'
	speed_test '6000' 'Time Warner Cable (Austin, TX, US)'
	speed_test '4438' 'Believe Broadband (Baltimore, MD, US)'
	speed_test '1774' 'Comcast (Boston, MA, US)'
	speed_test '8864' 'CenturyLink, Inc (Seattle, WA, US)'
	speed_test '10385' 'Speedtest.net (Washington, DC, US)'
	speed_test '7192' 'Sharktech Inc. (Denver, CO, US)'
	speed_test '13529' 'Switch (Las Vegas, NV, US)'
	speed_test '6101' 'Stephouse Networks (Portland, OR, US)'
	speed_test '3595' 'Tulix Systems, Inc (Atlanta, GA, US)'
	speed_test '6782' 'Broadwave (Miami, FL, US)'
    speed_test '6417' 'SysEleven GmbH (Berlin, Germany)'
	speed_test '2398' 'Studio Funk GmbH & Co. KG (Hamburg, Germany)'
	speed_test '9085' 'LWLcom GmbH (Munchen, Germany)'
	speed_test '1746' 'Vodafone DE (Frankfurt, Germany)'
	speed_test '226' 'Structured Communications (London, United Kingdom)'
	speed_test '15553' 'Linix Ltd (Liverpool, United Kingdom)'
	speed_test '1365' 'XILO (Sheffield, United Kingdom)'
	speed_test '3504' 'TNP Ltd. (Manchester, United Kingdom)'	
	speed_test '5582' 'Cloudwatt (Paris, France)'
	speed_test '4661' 'Orange (Marseille, France)'
	...
	speed_test '1328' 'MAN S.r.l. (Naples, Italy)'
	...
	speed_test '3033' 'WestNet Wireless (Calgary, AB, Canada)'
	speed_test '1493' 'Voyageur Internet (Winnipeg, MB, Canada)'
	speed_test '4978' 'NET S/A (Sao Paulo, Brazil)'
	...
	speed_test '15047' 'OPEN Project (via 20G SINET) (Tokyo, Japan)'
	speed_test '6508' 'at2wn (Yokohama, Japan)'
	speed_test '6476' 'rxy (individual) (Osaka, Japan)'
	speed_test '14840' 'poteitoo (Nagoya, Japan)'
    speed_test '6527' 'kdatacenter.com (Seoul, South Korea)'
    speed_test '3633' 'China Telecom (Shanghai, China)'
    speed_test '4665' 'China Mobile Group Shanghai Co.,LTD (Shanghai, China)'
    speed_test '5083' 'Shanghai Branch, China Unicom (Shanghai, China)'
}
