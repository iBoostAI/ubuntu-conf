...
speed() {
    ...
    speed_test '4042'  'SoftLayer Technologies (San Jose, CA, US) '
    speed_test '603'   'Unwired (San Francisco, CA, US)           '
    speed_test '4207'  'Shaw Communications (Calgary, Canada)     '
    speed_test '1752'  '5NINES, LLC (Madison, WI, US)             '
    ...
    speed_test '8040'  'IP-Projects GmbH (Frankfurt, Germany)     '
    speed_test '6151'  'Burstfire Networks (London, UK)           '
    speed_test '15553' 'Linix Ltd (Liverpool, UK)                 '
    speed_test '3504'  'TNP Ltd (Manchester, UK)                  '
